...
function Layout() {
  //Création de la fonction Layout pour l'accueil de l'application
  return (
    <>
      <Header />
      {/*Faire appel le header dans le components et le mettre en place */}
      <main className="main">
        {/**Main de la page */}
        <Outlet />{" "}
        {/**doit être utilisé dans les éléments de route parents pour restituer leurs éléments de route enfants */}
      </main>
      <Footer />
      {/**Pied de page */}
    </>
